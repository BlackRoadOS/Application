...
Open [os.blackroad.io](https://os.blackroad.io) in any browser. No signup required. Click roadcoin in the dock.

Or visit [roadcoin.blackroad.io](https://roadcoin.blackroad.io) directly.

## What It Does

roadcoin is one of 17 products in BlackRoad OS, a browser-based operating system running on 5 Raspberry Pi 5 computers with Hailo-8 AI accelerators.

- **     596 lines** of working code
