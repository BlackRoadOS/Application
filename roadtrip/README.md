# roadtrip — BlackRoad OS

**Live:** [roadtrip.blackroad.io](https://roadtrip.blackroad.io)
**Part of:** [BlackRoad OS](https://os.blackroad.io) — browser-based desktop with 27 AI agents

## Try It

Open [os.blackroad.io](https://os.blackroad.io) in any browser. No signup required. Click roadtrip in the dock.

Or visit [roadtrip.blackroad.io](https://roadtrip.blackroad.io) directly.

## What It Does

roadtrip is one of 17 products in BlackRoad OS, a browser-based operating system running on 5 Raspberry Pi 5 computers with Hailo-8 AI accelerators.

- **    7602 lines** of working code
